...
import net.servehttp.bytecom.model.jpa.comercial.ConexaoJPA;
import net.servehttp.bytecom.model.jpa.entity.comercial.Cliente;
import net.servehttp.bytecom.model.jpa.entity.comercial.Conexao;
import net.servehttp.bytecom.model.jpa.entity.provedor.impl.Mikrotik;
import net.servehttp.bytecom.model.jpa.provedor.MikrotikJPA;
