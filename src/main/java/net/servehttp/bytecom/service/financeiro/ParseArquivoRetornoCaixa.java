...
import net.servehttp.bytecom.persistence.jpa.entity.financeiro.retorno.*;
...
public class ParseArquivoRetornoCaixa implements Serializable {
    ...
    public Header parse(InputStream input, String fileName) throws IOException {
        return lerArquivoRetornoCaixa(input, fileName);
    }
