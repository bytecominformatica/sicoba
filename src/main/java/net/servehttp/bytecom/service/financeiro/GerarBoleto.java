...
public abstract class GerarBoleto implements Serializable {
    ...
    public static byte[] criarCarneCaixa(List<Mensalidade> mensalidades,
                                         net.servehttp.bytecom.persistence.jpa.entity.financeiro.Cedente c) {
        if (mensalidades != null && !mensalidades.isEmpty()) {
            ...
            mensalidades.forEach(m -> {
                ...
                String parcela = mensalidades.indexOf(m) + 1 + "/" + mensalidades.size();
                Boleto boleto = getBoleto(m, titulo, c, parcela);
    ...
    private static Boleto getBoleto(Mensalidade m, Titulo titulo,
                                    net.servehttp.bytecom.persistence.jpa.entity.financeiro.Cedente cedente, String parcela) {
    /*
     ...
     */
        ...
        boleto.setInstrucao6("PARCELA " + parcela);
