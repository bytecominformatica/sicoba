...
public abstract class ImageUtil implements Serializable {
    ...
    public static byte[] tratarImagem(InputStream is) throws IOException {
        byte[] byteArray = null;
        if (is != null) {
    ...
    public static byte[] setThumbnail(byte[] arquivo, String extensao) throws IOException {
     ...
     * @return String
     */
    public static String exibirImagem(byte[] bytesImage, String filename, String folderImages) throws IOException {
        if (bytesImage == null) {
            return null;
        }
        String path = "";
